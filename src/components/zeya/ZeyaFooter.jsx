...
export default function ZeyaFooter() {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
              ...
              <div className="w-12 h-12 rounded-full overflow-hidden border flex items-center justify-center flex-shrink-0"
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.parentElement.innerHTML = `<span style="font-family:'Playfair Display',serif;font-weight:700;font-size:16px;background:linear-gradient(135deg,${GOLD},#A6852A);-webkit-background-clip:text;-webkit-text-fill-color:transparent;letter-spacing:1px">ZC</span>`
                  }}
                />
              </div>
              <div>
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: 'rgba(255,255,255,0.4)' }}>
              Votre conciergerie de confiance pour des séjours sur mesure, alliant confort, sérénité et excellence à chaque étape.
            </p>
      ...
      <div style={{ borderTop: `1px solid ${GOLD}10` }}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>
            © {year} ZEYA Conciergerie — APISAHI Group. Tous droits réservés.
          </p>
